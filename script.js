...
let overall_boost = 1;
let overall_cookies = 0; //TO DO
let overall_cookiesPa = 0; //TO DO
let overall_cookiesClicks = 0; //TO DO
let Cookie_point = 0; //TO DO
let overall_Cookie_Point = 0;
let Click_bonus = 0; //To DO
let Rebirth_Counter = 0;//TO DO
let four_bonus = 1;
let robot_bonus = 1;
let usine_bonus = 1;
let mamie_bonus = 1;
